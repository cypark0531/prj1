...
@WebServlet("/storagemusic/secect")
public class StorageboxmusicController extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		String id = (String)req.getSession().getAttribute("id");
		  ...
		  System.out.println("dddd="+pageCount);
		  System.out.println("dddd="+endRow);
		  ...
		  req.getRequestDispatcher("/storagebox/storageboxmusiclist.jsp").forward(req, resp);
	}
}
