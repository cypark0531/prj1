...
<div class="wrap" style=" padding: 60px 60px 60px 60px; border-style: dotted;" >
	...
	<form id="boardForm" name="boardForm"  action="${pageContext.request.contextPath }/board/insert" method="post" onsubmit ="return check()">
	<table   class="table02"  >
	<caption><strong style="font-size: 20px; color: #ffffff;">'<span class="t_red">*</span>' This mark is required input items.</strong></caption>
		...
		<td><input  type= "text" id="btitle" name="btitle" value="" class="tbox1"  style=" width:400px; height:auto; background-color:  #121418;color: white;font-size: 16px;border: none; " autofocus="autofocus"  tabindex="1" onkeyup=""></td>
		</tr>
		<tr>
		<th>BOARD CONTENT<span class="t_red"> *</span></th>
        <td><textarea id="bcontent" name="bcontent" cols="10" rows="5" class="textarea01" style="width:700px; height:200px; background-color:  #121418;color: white;font-size: 16px;border: none;" tabindex="3" onkeyup="" ></textarea></td>
		</tr>
