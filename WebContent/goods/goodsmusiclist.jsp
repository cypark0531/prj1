		...
		<div class="page_wrap">
	      <div class="page_nation">
			  <c:if test="${startPageNum>5 }">
			    <a href="${pageContext.request.contextPath }/music/select?pageNum=${startPageNum-1 }&id=${requestScope.id}&gcategory=${requestScope.gcategory}"><</a>
			  </c:if>
			  <c:forEach var="i" begin="${startPageNum }" end="${endPageNum }">
			    <c:choose>
			      <c:when test="${pageNum==i }">
			        <a href="${pageContext.request.contextPath }/music/select?pageNum=${i }&id=${requestScope.id}&gcategory=${requestScope.gcategory}">
			  ...
			  <c:if test="${endPageNum < pageCount }">
			     <a href="${pageContext.request.contextPath }/music/select?pageNum=${endPageNum+1 }&id=${requestScope.id}&gcategory=${requestScope.gcategory}">></a>
			  </c:if>
		  </div>
		</div>
		<div class="btn_right mt15">
